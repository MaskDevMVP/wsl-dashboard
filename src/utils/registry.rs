use windows::Win32::System::Registry::{
    HKEY, HKEY_CURRENT_USER, KEY_READ, REG_DWORD, REG_OPEN_CREATE_OPTIONS, REG_SZ, REG_VALUE_TYPE,
...
pub fn get_system_locale() -> String {
    ...
    unsafe {
        if RegOpenKeyExW(
            HKEY_CURRENT_USER,
            PCWSTR(encode_wide(subkey).as_ptr()),
            0,
            KEY_READ,
            &mut hkey,
        )
...
pub fn write_reg_string(
    ...
    unsafe {
        use windows::Win32::System::Registry::{
            KEY_WRITE, REG_SZ, RegCreateKeyExW, RegSetValueExW,
        };
        RegCreateKeyExW(
            root,
...
pub fn delete_reg_value(
    ...
    let mut hkey = HKEY::default();
    unsafe {
        use windows::Win32::System::Registry::{KEY_SET_VALUE, RegDeleteValueW, RegOpenKeyExW};
        RegOpenKeyExW(
            root,
            PCWSTR(subkey_wide.as_ptr()),
            0,
